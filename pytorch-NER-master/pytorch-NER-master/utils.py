...
class WordVocabulary(object):
    ...
    def save(self):
        with open('data\word_to_id.pickle', 'wb') as handle:
            pickle.dump(self._word_to_id, handle)
        with open('data\id_to_word.pickle', 'wb') as handle:
            pickle.dump(self._id_to_word, handle)
...
class LabelVocabulary(object):
    ...
    def save(self):
        with open('data\id_to_label.pickle', 'wb') as handle:
            pickle.dump(self._id_to_label, handle)
        with open('data\label_to_id.pickle', 'wb') as handle:
            pickle.dump(self._label_to_id, handle)
